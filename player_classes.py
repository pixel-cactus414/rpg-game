...
warrior = {
    "name": "Рыцарь",
    "description": "Рыцарь - опытный воин и вдохновляющий лидер команды, мастерски владеющий рапирой. Он не только наносит уверенные удары, но и служит сердцем команды и опорой для союзников, усиливая их в атаке. Его присутствие на поле боя вселяет уверенность и помогает команде выдержать самые сложные испытания.",
    "class": "damage",
    "icon": damage_icon,
    "max_hp": 80,
    "hp": 80,
